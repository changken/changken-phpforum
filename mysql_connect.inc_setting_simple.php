...
define("DB_HOSTNAME","MySQL資料庫主機地址");//MySQL資料庫主機地址
define("DB_NAME","MySQL資料庫名稱");//MySQL資料庫名稱
define("DB_USERNAME","MySQL資料庫使用者");//MySQL資料庫使用者
define("DB_PASSWORD","MySQL資料庫使用者密碼");//MySQL資料庫使用者密碼
?>